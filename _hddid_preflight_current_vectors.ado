*! _hddid_preflight_current_vectors -- Validate stored estimation results
*! before postestimation operations.  Verifies shape, finiteness,
*! label consistency, and algebraic coherence of e() matrices.
...
program define _hddid_preflight_current_vectors
    ...
    * ------ Validate e(z0): nonparametric evaluation grid ------
    ...
    * ------ Recover p from stored matrices when e(p) is absent ------
    ...
    * ------ Recover qq from e(z0) or e(CIpoint) ------
    ...
    * ------ Recover expected beta coordinate labels ------
    ...
    * ------ Validate e(xdebias): debiased parametric coefficients ------
    ...
    * ------ Validate e(b): generic Stata coefficient vector ------
    ...
    * ------ Cross-validate e(b) against e(xdebias) ------
    ...
    * ------ Validate e(stdx): parametric standard errors ------
    ...
    * ------ Validate e(CIpoint): pointwise confidence intervals ------
    ...
    if _rc == 0 {
        ...
        if rowsof(`_cipoint') != 2 | ///
            ...
            di as error "{bf:hddid}: e(CIpoint) must be 2 x (p + qq)"
            exit 498
        }
        ...
        if `"`_cipoint_rownames_actual'"' != "lower upper" {
            di as error "{bf:hddid}: e(CIpoint) must use rownames {bf:lower upper}"
            exit 498
        }
    ...
    * ------ Validate e(gdebias): debiased nonparametric coefficients ------
    ...
    * ------ Validate e(CIuniform): uniform confidence band ------
    ...
    * ------ Validate e(stdg): nonparametric standard errors ------
    ...
    * ------ Verify CIpoint and CIuniform endpoint ordering ------
    ...
    * ------ Verify bundle completeness of stored e() objects ------
    ...
    if `_has_z0' == 0 {
        ...
        if `"`_nonparam_bundle_missing_z0'"' != "" {
            ...
            di as error "  Object(s) missing shared evaluation grid: {bf:`_nonparam_bundle_missing_z0'}"
            exit 498
        }
    }

    * ------ Validate e(tc) and algebraic consistency with CIuniform ------
    ...
    if `_has_ciuniform' & `_has_gdebias' & `_has_stdg' & `_has_tc' {
        ...
        if scalar(`_stdg_absmax') <= scalar(`_zero_stdg_tol') {
            ...
            if abs(`_tc'[1,1]) <= scalar(`_tc_tol') & ///
                ...
                di as error "  A nonzero e(stdg) with e(tc) = (0, 0) would collapse e(CIuniform) to e(gdebias)."
                exit 498
            }
        }
    }
    * ------ Verify CIpoint algebraic consistency ------
